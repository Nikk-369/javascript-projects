// Fuction called whenever user tab on any box
function myfunc() {
    ...
    // Checking of player 0 starts is player 0 won or
    // not and after disabled all the others fields
    ...
    // here , checking about tie
        ...
        document.getElementById('print').innerHTML = "Match Tie Hogya";
        window.alert('Match tie hogya')
    }
    else {
